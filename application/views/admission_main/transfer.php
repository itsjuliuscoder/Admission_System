		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-right">
					...
					<li><a href="<?php echo base_url(); ?>transfer" class="link-nav active scroll"><span data-letters="Transfer">Transfer</span></a></li>
...
<div class="transfer-heading text-center">
	<div class="container zoomIn animated">	
		<h1 class="page-title">Transfer Students<span class="title-under"></span></h1>
...
<div class="ugrad">
	<div class="note">
		<div class="container">
			<div class="row" style="margin-bottom:4em;">
				<!--<div class="col-md-6 note_3 animated wow lightSpeedIn">
					<div class="note_tit">
						<h3>TRAINING EXPERTISE</h3>
						<p>We at HNAUB possess the competent academicians and professionals capable of provide requisite training and skills for the development of African executives and managers that are prime and readily marketable to the economic arena of our nations.</p> 
					</div>
				</div>-->
				<!--<div class="col-md-6 note_4 animated wow lightSpeedIn">
					<div class="note_tit">
						<h3>STUDY GROUPS</h3>
						<p>Meet with fellow students who have strong desire you can walk along with on your road to SUCCESS.</p> 
					</div>
				</div>-->
				<!--<div class="col-md-4">
					<img src="<?php // echo base_url(); ?>images/transfer.jpg" class="img-responsive">
				</div>
				<div class="col-md-4">
					<img src="<?php //echo base_url(); ?>images/transfer.jpg" class="img-responsive">
				</div>	
				...
				<div class="col-md-6">
					<div class="col-md-6">
						<h3 style="color:#1873cc;">Why continue with HNAUB?</h3>&nbsp;
						<p>At HNAUB, we are aware that all transfer students seek a better futherance of the studies. For these purpose we have structured our system here at HNAUB not just to meet your academic needs but your socail and phychological needs.</p>
					</div>
					<div class="col-md-6">
						<img src="<?php echo base_url(); ?>images/transfer.jpg" class="img-responsive" height="400">
					</div>
				</div>
				<div class="col-md-6">
					<div class="col-md-6">
						<img src="<?php echo base_url(); ?>images/transfer1.jpg" class="img-responsive">
					</div>
					<div class="col-md-6">
						<h3 style="color:#1873cc;">Why continue with HNAUB?</h3>&nbsp;
						<p>At HNAUB, we are aware that all transfer students seek a better futherance of the studies. For these purpose we have structured our system here at HNAUB not just to meet your academic needs but your socail and phychological needs.</p>
	...
	<div class="container">		
		<div class="main row">
			...
			<div class="col-md-6">
				<img src="<?php echo base_url(); ?>images/cos9.jpg" class="img-responsive">
			</div>	
			<div class="col-md-6">
				<h2 style="color:#1873CC;"><b>HNAUB</b> Academic Structure</h2>&nbsp;
				<p>Here in HNAUB, we have a well organised Academic Struture that lay emphasis on simplicity and easitability of students. Our Academic System is built on the American Academic Curricullum. </p>
			</div>
                    ...
                    <div class="panel-heading" role="tab" id="headingTwo">
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                <i class="fa fa-pencil-square-o icon_3"></i> ADMISSION REQUIREMENTS FOR TRANSFER STUDENTS
                            </a>
                        </h4>
                    </div>
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="false" style="height: 0px;">
                        <div class="panel-body">
								<ol>
									...
									<li>Official Transcript of Previous University</li>
								</ol>                            
                        </div>
                    </div>
                </div>
							...
							<ul class="rslides" id="slider3">
								<li>
									<div class="testimonials-grids">
										<img src="<?php echo base_url();?>images/testimonials/samuel.jpg" alt="" class="img-responsive" />
										<p><b>HNAUB</b> has made me realised the important of learning another world language; French. Its a great challenge for me, learning a new language from scratch.</p>
										<h4>Samuel John<a href=""></a></h4>
									</div>
								</li>
								<li>
									<div class="testimonials-grids">
										<img src="<?php echo base_url();?>images/testimonials/john.jpg" alt=" " class="img-responsive" />
										<p>As a bonafide student of <b>HNAUB</b>, I must confess that we have best sets of students here in Benin Republic in terms of academic ability and social exposure.</p>
										<h4>John<a href=""></a></h4>
									</div>
								</li>
								<li>
									<div class="testimonials-grids">
										<img src="<?php echo base_url();?>images/testimonials/021.jpg" alt=" " class="img-responsive" />
										...
										<h4>Julius Olajumoke<a href=""></a></h4>
									</div>
								</li>
							</ul>
						</div>
