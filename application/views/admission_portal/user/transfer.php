<div class="hcontent">
	...
	<div class="hbody">
		<div class="container-fluid">
			...
			<div class="hnews">
				<div class="row">
					<div class="col-md-6">
						<img src="<?php echo base_url();?>images/Image 6.png" class="img-responsive">
					</div>
					<div class="col-md-6">
						<h3 style="margin-top:-3px;">HNAUB is open for You</h3>
						<p>Students are characterised has education consumers that invest massively into a University Education System. For this reason finding the right place to investing along side acquire the right education is always a question every students encounter</p>
						<p>At HNAUB, we possess the capability for any willing students to consume at his capacity.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="happly">
		<div class="container-fluid">
			<h2>Apply to HNAUB as a Transfer Student</h2>
			<!--<p>Applying to HNAUB as been made easier at your convinence, just follow the stated steps below</p>-->
			<div class="apply">
				<a href="<?php echo base_url(); ?>admission_portal/user/apply/transfer" class="btn btn-success">Apply Now</a>
			</div>
		</div>
	</div><div class="clearfix"></div>
		<!-- hinfo -->
