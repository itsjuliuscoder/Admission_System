<div class="hcontent">
				...
				<div class="navbar navbar-inverse bg-indigo-400 navbar-component" style="position: relative; z-index: 23;">
									<div class="navbar-header">
										...
										<ul class="nav navbar-nav pull-left">
											...
											<li><a data-toggle="collapse" data-target="#navbar-text" href="<?php echo base_url(); ?>admission_portal/admission_news"><i class="icon-menu2"></i>&nbsp;&nbsp; Admission News</a></li>
	...
	<div class="hbody">
		<div class="container-fluid">
			...
			<div class="hnews">
				...
				<div class="row">
					<div class="col-md-4">
						<!--<h4>HNAUB affiliates with Plymouth University</h4>-->
						<p>Houdegbe North American University Benin Republic yesterday, reached a milestone since it was founded in 1992 by announcing it affiliation with Plymouth State University New Hampshire in the USA.</p>
						<!--<a href="" class="btn btn-block"> Read More</a>-->
					</div>
					<div class="col-md-8">
						<img src="<?php echo base_url(); ?>images/lok.jpg" class="img-responsive">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="happly">
		<div class="container">
			<h2>Apply to HNAUB for Graduate Studies</h2>
