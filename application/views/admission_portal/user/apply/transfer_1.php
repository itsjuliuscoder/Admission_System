				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Transfer Student Form</h5>
								...
								<fieldset class="content-group">
									...
									<div class="row">
										<div class="col-lg-3">
											<div class="form-group has-feedback">
												...
												<div class="col-lg-12">
													<label>Name of College/Universities: <span class="text-danger">*</span></label>
			                                		<input type="text" name="uniname" placeholder="Name of College/Univerisities attended" class="form-control">
										...
										<div class="col-lg-3">
											<div class="form-group has-feedback">
												...
												<div class="col-lg-12">
													<label>Address of College/Universities:</label>
			                                		<textarea name="uniaddress" rows="4" cols="4" placeholder="10, Shofolahan Street, Ijeshatedo, Surulere, Lagos." class="form-control"></textarea>
												</div>
											</div>
										</div>
										<div class="col-lg-3">
											<div class="form-group has-feedback">
												...
												<div class="col-lg-12">
													<label>Year Attended:</label>
													<select name="uniattendyear" data-placeholder="Year Attended" class="select">
						                                        <option></option> 
						                                        	<option value="1966">1966</option>
																	<option value="1967">1967</option>
																	<option value="1968">1968</option>
										...
										<div class="col-lg-3">
											<div class="form-group has-feedback">
												...
												<div class="col-lg-12">
													<label>Year Graduated:</label>
													<select name="unigradyear" data-placeholder="Year Graduated" class="select">
						                                        <option></option> 
						                                        	<option value="1966">1966</option>
																	<option value="1967">1967</option>
																	<option value="1968">1968</option>
									...
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="col-lg-12">
													<label>If you are currently attending college, how many classes have you taken?: <span class="text-danger">*</span></label>
											<div class="row">
												<div class="col-md-2">
													<div class="radio">
														<label>
															<input type="radio" name="plevel" class="styled" value="100">
															100
														</label>
													</div>
												</div>
												<div class="col-md-2">
													<div class="radio">
														<label>
															<input type="radio" name="plevel" class="styled" value="200">
															200
														</label>
													</div>
												</div>
												<div class="col-md-2">
													<div class="radio">
														<label>
															<input type="radio" name="plevel" class="styled" value="300">
															300
														</label>
													</div>
												</div>
												<div class="col-md-2">
													<div class="radio">
														<label>
															<input type="radio" name="plevel" class="styled" value="400">
															400
														</label>
													</div>
												</div>
												<div class="col-md-2">
													<div class="radio">
														<label>
															<input type="radio" name="plevel" class="styled" value="500">
															500
														</label>
													</div>
												</div>
												<div class="col-md-2">
													<div class="radio">
														<label>
															<input type="radio" name="plevel" class="styled" value="600">
															600
														</label>
													</div>
												</div>
										...
										<div class="col-lg-4">
											<div class="form-group has-feedback">
												...
												<div class="col-lg-12">
				                                    ...
				                                    <select name="cobirth" data-placeholder="Select a country..." class="select required">
				                                        <option></option> 
											...
											<div class="form-group has-feedback">
												...
												<div class="col-lg-12">
													<label>Where did you find us? <span class="text-danger">*</span></label>
					                                    <select name="source" data-placeholder="Choose an option..." class="select required">
					                                        <option></option> 
